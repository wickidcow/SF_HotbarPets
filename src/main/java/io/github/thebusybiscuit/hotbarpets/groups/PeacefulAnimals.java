...
import io.github.thebusybiscuit.hotbarpets.pets.NautilusPet;
...
public final class PeacefulAnimals implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        ...
        if (plugin.isModernPetEnabled("nautilus")) {
            new NautilusPet(plugin.getItemGroup(), new SlimefunItemStack(
                "HOTBAR_PET_NAUTILUS", Material.NAUTILUS_SPAWN_EGG, "&3Nautilus Pet", getName(),
                "&7Favourite Food: Raw Cod", "", "&fRight-Click: &7Gives you Conduit Power"
            ), new ItemStack(Material.COD), new ItemStack[]{
                new ItemStack(Material.PRISMARINE_CRYSTALS), new ItemStack(Material.NAUTILUS_SHELL), new ItemStack(Material.PRISMARINE_CRYSTALS),
                new ItemStack(Material.COD), new ItemStack(Material.EMERALD), new ItemStack(Material.COD),
                new ItemStack(Material.PRISMARINE_SHARD), SlimefunItems.GOLD_18K, new ItemStack(Material.PRISMARINE_SHARD)
            }).register(plugin);
        }
    }
}
